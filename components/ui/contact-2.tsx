    ...
    <section className="py-32">
      <div className="container">
        <div className="mx-auto flex max-w-screen-xl flex-col justify-between gap-10 lg:flex-row lg:gap-20">
          ...
          <form className="relative z-10 mx-auto flex max-w-screen-md flex-col gap-6 rounded-lg border p-10" onSubmit={onSubmit}>
            ...
            <div className="grid w-full gap-1.5">
              ...
              <Textarea placeholder="Type your message here." id="message" name="message" rows={5} />
            </div>
